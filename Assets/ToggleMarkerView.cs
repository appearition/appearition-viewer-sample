...
public class ToggleMarkerView : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        var markerlessHandler = FindObjectOfType<VuforiaCloudProviderHandler>();
    ...
    {
        if (AppearitionArHandler.ProviderHandler is VuforiaCloudProviderHandler)
        {
    ...
    public void StartProvider()
    {
        ...
        AppearitionArHandler.ChangeArProvider<VuforiaCloudProviderHandler>();
    }

    private void AppearitionArHandler_OnProviderStateChanged(BaseArProviderHandler provider, bool isActive)
    {
        if (provider is VuforiaCloudProviderHandler && isActive)
        {
