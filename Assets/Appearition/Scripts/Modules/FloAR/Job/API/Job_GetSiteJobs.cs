...
{
    /// <summary>
    /// https://api.appearition.com/TenantName/api/Job/GetSiteJobs/0 , where 0 is Channel ID 
    /// </summary>
    [System.Serializable]
    public class Job_GetSiteJobs : BaseApiGet
    {
