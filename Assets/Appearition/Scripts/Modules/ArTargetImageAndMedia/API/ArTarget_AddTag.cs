...
{
    /// <summary>
    /// https://api.appearition.com/TenantName/api/ArTarget/AddTag/0?arTargetId=1&tag=tmp , where 0 is Channel ID, 1 is Ar Target ID and tmp is the tag to be added.
    /// </summary>
    [System.Serializable]
    public class ArTarget_AddTag : BaseApiPost
    {
