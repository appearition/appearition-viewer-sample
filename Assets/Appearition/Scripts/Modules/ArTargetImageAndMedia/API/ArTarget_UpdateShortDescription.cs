...
{
    /// <summary>
    /// https://api.appearition.com/TenantName/api/ArTarget/UpdateShortDescription/0?arTargetId={1} , where 0 is Channel ID and 1 ArTarget id.
    /// </summary>
    [System.Serializable]
    public class ArTarget_UpdateShortDescription : BaseApiPost
    {
